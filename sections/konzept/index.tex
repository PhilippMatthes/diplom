...
Als Ausgangspunkt für die datenorientierte Verkehrsmittelerkennung durch ML-Systeme muss ein Datensatz akquiriert werden. Dieser kann selbstständig erzeugt werden, beispielsweise durch Aufzeichnung über eine prototypische Applikation, oder aus verwandten Arbeiten übernommen werden. Da bereits zahlreiche öffentliche Datensätze zur Verfügung stehen und die Nutzung eines solchen Datensatzes die Vergleichbarkeit der Ergebnisse verbessert, wird ein öffentlicher Datensatz zum Training und zur Evaluation der Modelle selektiert.
