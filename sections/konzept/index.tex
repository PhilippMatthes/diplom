...
\subsubsection{Experimentelle Vorbedigungen}

\subsubsection{Messung der Inferenzzeit durch Unit-Tests}

\subsubsection{Messung des Energieverbrauchs}

% Abstract Energy Units

\subsubsection{Messung der verbleibenden Ressourcenparameter}

\subsection{Tradeoff-Modellierung}

\section{Kollaborative Optimierung}

\subsection{Pruning für On-Device-Inferenz}

\subsection{Clustering und Quantization Aware Training}
