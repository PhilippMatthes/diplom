...
\item Verwandte Arbeiten
  ...
  \item Bestehende Ansätze des Movebis-Projektes
    \begin{gliederung}
    \item Klassifikation über Support Vector Machines und Random Forests nach \Cref{matusek_anwendung_2019}
    \item Klassifikation über Recurrent Neural Networks nach \Cref{werner_kontinuierliche_2020}
    \item Klassifikation über Convolutional Neural Networks nach \Cref{stojanov_continuous_2020}
