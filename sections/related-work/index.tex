...
\paragraph{CPU-Zeit und Energieverbrauch:} Ein weiteres zentrales Ergebnis aus \cite{brownlee_exploring_2021}, welches methodisch für diese Arbeit relevant ist, besteht darin, dass die in Anspruch genommene CPU-Zeit der Modelle (Training, Inferenzzeit) nicht zwangsweise linear mit der verbrauchten Energie korelliert.
