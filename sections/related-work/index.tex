...
Die Ansätze \cite{matusek_anwendung_2019,werner_kontinuierliche_2020,stojanov_continuous_2020} bilden den Ausgangspunkt für diese Arbeit.

% Matusek als Ausgangspunkt für Ansätze
% - Fokus auf Datenvorverarbeitung -> Führt Glättung, Alignment, Interpolation, Prozessierung durch AHRS, Kalman-GNSS-Korrektur ein
% - Evaluation ggü. Random Forest -> Auch diese Ansätze sollten nicht in Vergessenheit geraten
% - Ergebnisse: tiefergehendes Feature-Engineering notwendig, saubere Labelung wichtig
% - Wichtige Beobachtung: Lücken in GPS-Daten! S. 105
...
% Vorverarbeitung
% Matusek: Smoothing, Alignment, Interpolation, Prozessierung durch AHRS, Kalman-GNSS-Korrektur
% Stojanov:
