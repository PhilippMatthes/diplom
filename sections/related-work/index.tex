...
\paragraph{Training:} Abschließend lässt sich zur Übersicht erwähnen, dass zum Training der Modelle grundsätzlich verschiedene Methoden angewandt werden können, das Reinforcement Learning findet sich allerdings in keiner der betrachteten Arbeiten wieder. \todo[inline]{weiter ausführen}.
