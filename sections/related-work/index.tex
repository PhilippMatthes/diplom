...
% - Betrachtung der Ressourcenparameter qa:r
...
\begin{table}[h]
  ...
  Arbeit & \nameref{qa:vme} & \nameref{qa:e} & \nameref{qa:inf} & \nameref{qa:s} & \nameref{qa:q} & \nameref{qa:b} & \nameref{qa:o} & \nameref{qa:int} \\
  \midrule
  \multicolumn{9}{l}{Movebis-Ansätze} \\
  \midrule
  \multicolumn{9}{l}{VME-Ansätze} \\
  \midrule
  \multicolumn{9}{l}{HAR-S-Ansätze} \\
  \midrule
  \multicolumn{9}{l}{VME-S-Ansätze} \\
  \midrule
  \multicolumn{9}{l}{Tradeoff-Ansätze} \\
  \bottomrule
  \end{tabular}\label{tab:abgrenzung}
