...
\begin{table}[h]
  ...
  \caption{Vergleich verschiedener Machine-Learning-Ansätze für \acrshort{vme}.}
  }
\end{table}
...
\todo[inline]{Sektion ist in Bearbeitung}

\begin{longtable}[H]{lcccccccc}
  \toprule
   & & \multicolumn{3}{c}{\nameref{qa:r}} & & & \\
  \cmidrule(lr){3-5}
  Arbeit &
  ...
  \midrule
  \endhead
  \multicolumn{9}{l}{Verkehrsmittelerkennung über Machine-Learning-Modelle} \\
  \midrule
  \cite{matusek_anwendung_2019} &
  ...
  \cite{werner_kontinuierliche_2020} &
    ...
    \cmark & % - Betrachtung der Ergebnisqualität qa:q
    & % - Ermittlung des bestmöglichen Modells aus einer Selektion qa:b
    \cmark\footnote{\label{fn:pp}Nur Optimierung durch Postprocessing} & % - Betrachtung von verschiedenen Optimierungsmöglichkeiten qa:o
    % - Portierbarkeit auf Smartphones als Konzeptbestandteil qa:int
    \\
  \cite{stojanov_continuous_2020} &
    \cmark & % - Betrachtung von Verkehrsmittelklassifikation qa:vme
    ...
    \cmark & % - Betrachtung der Ergebnisqualität qa:q
    & % - Ermittlung des bestmöglichen Modells aus einer Selektion qa:b
    \cmark\footnoteref{fn:pp} & % - Betrachtung von verschiedenen Optimierungsmöglichkeiten qa:o
    % - Portierbarkeit auf Smartphones als Konzeptbestandteil qa:int
    \\
    ...
    & % - Betrachtung der Inferenzzeit qa:inf
    & % - Betrachtung des Speicherverbrauchs qa:s
    & % - Betrachtung der Ergebnisqualität qa:q
    & % - Ermittlung des bestmöglichen Modells aus einer Selektion qa:b
    & % - Betrachtung von verschiedenen Optimierungsmöglichkeiten qa:o
    % - Portierbarkeit auf Smartphones als Konzeptbestandteil qa:int
    \\
  ...
  \cite{jeyakumar_deep_2018} & % - Arbeit
    ...
    \\
  \midrule
  \multicolumn{9}{l}{Human Activity Recognition über Machine-Learning-Modelle} \\
  \midrule
  ...
  \cite{mairittha_-device_2021} & % - Arbeit
    ...
    \\
  \midrule
  \multicolumn{9}{l}{Optimierung von Machine-Learning-Modellen} \\
  \midrule
  \cite{han_learning_2015} & % - Arbeit
    & % - Betrachtung von Verkehrsmittelklassifikation qa:vme
    & % - Betrachtung des Energieverbrauchs qa:e
    & % - Betrachtung der Inferenzzeit qa:inf
    & % - Betrachtung des Speicherverbrauchs qa:s
  ...
  \cite{han_deep_2016} & % - Arbeit
    ...
    % - Portierbarkeit auf Smartphones als Konzeptbestandteil qa:int
    \\
  \cite{ian_goodfellow_deep_2016} & % - Arbeit
    & % - Betrachtung von Verkehrsmittelklassifikation qa:vme
    & % - Betrachtung des Energieverbrauchs qa:e
    & % - Betrachtung der Inferenzzeit qa:inf
    & % - Betrachtung des Speicherverbrauchs qa:s
    ...
    % - Portierbarkeit auf Smartphones als Konzeptbestandteil qa:int
    \\
  \cite{howard_mobilenets_2017} & % - Arbeit
    & % - Betrachtung von Verkehrsmittelklassifikation qa:vme
    & % - Betrachtung des Energieverbrauchs qa:e
    & % - Betrachtung der Inferenzzeit qa:inf
    & % - Betrachtung des Speicherverbrauchs qa:s
