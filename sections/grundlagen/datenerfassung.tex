...
Ein Koordinatensystem, welches einen oder eine Kombination aus solchen Algorithmen nutzt, um die Lage des Gerätes als Weltkoordinatensystem zu rekonstruieren, wird auch als \textit{Attitude and Heading Reference System (\acrshort{ahrs})} bezeichnet. Es existieren zahlreiche Verfahren zur Transformation der Sensordaten in ein solches System.
