...
Diese Fragen sollen in den folgenden Sektionen diskutiert werden. Wie in \Cref{fig:kinematische-messparameter} gezeigt, handelt es sich hierbei jeweils um Messparameter, die in drei Dimensionen erfasst werden. Dies ist jeweils entweder eine Richtung mit Betrag (Akzelerometer, Magnetometer) oder eine Winkelauslenkung in drei Dimensionen.
