\section{Datenerfassung und -vorverarbeitung}\label{sec:datenerfassung-und-vorverarbeitung}
...
wobei:
\begin{conditions}
  d \in D \subseteq \mathbf{Q} & Der gewählte Datenpunkt aus der Datenpunktmenge $D$
\end{conditions}
