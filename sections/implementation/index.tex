...
Die Implementation der traditionellen Modelle erfolgt über Scikit-Learn, die der Deep-Learning-Modelle über Keras. Die Datenvorverarbeitung erfolgt über Schnittstellen von Pandas, Numpy, Imbalanced Learn und Scikit-Learn. Alle implementierten Modelle werden in der Cloud auf dem heruntergeladenen \acrshort{shl}-Datensatz über eine NVIDIA P-100 GPU trainiert. Die Implementation der ResNet-Hyperarchitektur erfolgt auf Grundlage von Kerastuner, worüber auch die Hyperband-Rastersuche durchgeführt wird. Die besten 10 Modelle werden selektiert und finalisiert. Die Portierung erfolgt mit TensorFlow Lite in eine prototypische iOS-App, auch anhand der Android-App, welche zur Aufzeichnung des \acrshort{shl}-Datensatzes verwendet wurde. Für die Integrations- und Unittests wird auf die Schnittstellen von Xcode zurückgegriffen. Das externe Profiling erfolgt ebenfalls durch Xcode. Die Optimierung wird umgesetzt durch das TensorFlow Model Optimization Toolkit.
