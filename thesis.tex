...
\documentclass[
  ...
  cdgeometry=centered, % use two-side for booklike layouts
...
\usepackage{caption}
\captionsetup{font=rm,labelfont=rm,labelsep=space}
\usepackage{floatrow}
\floatsetup{font=rm}
...
\begin{document}
  ...
  \input{sections/grundlagen/index.tex}
  \input{sections/analyse/index.tex}
  \input{sections/related-work/index.tex}
  \input{sections/konzept/index.tex}
  \input{sections/implementation/index.tex}
  \input{sections/evaluation/index.tex}
  \input{sections/fazit/index.tex}
